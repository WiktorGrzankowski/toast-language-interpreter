...
-- | The abstract syntax of language Toast.

module Toast.AbsToast where
...
data Program' a = Prg a [Stmt' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Arg = Arg' BNFC'Position
data Arg' a = Ar a (Type' a) Ident | ArgRef a (Type' a) Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
type ExprArg = ExprArg' BNFC'Position
data ExprArg' a = EArg a (Expr' a) | EArgRef a Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
instance HasPosition ExprArg where
  hasPosition = \case
    EArg p _ -> p
    EArgRef p _ -> p
